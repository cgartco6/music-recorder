...
class MusicRecorderPro {
    ...
    startAnalysisLoop() {
        this.analysisInterval = setInterval(async () => {
            ...
            // AI Character lip-sync based on audio energy
    ...
    async stopRecording() {
        ...
        const audioBlob = await this.recorder.stop(); // raw recording
        // Also apply offline noise cancellation to final audio
